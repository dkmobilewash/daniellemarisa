...
export const santaFe: CityContent = {
  ...
  packages: [
    {
      ...
      features: [
        ...
        "Welcome event / rehearsal dinner planning",
        "Full design, budget, and contract management",
        "Multi-day, on-site coordination team",
      ],
    },
    {
    ...
    },
    {
      ...
      features: [
        ...
        "Timeline built around light and altitude",
      ],
    },
  ],
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        "Yes — most of our Santa Fe clients plan from out of state. We handle local venue visits, vendor meetings, and site logistics on your behalf and keep you updated by video call, so distance doesn't slow down your planning.",
    },
    {
      question: "How far in advance should we book our Santa Fe venue?",
      answer:
        "Santa Fe's most popular historic properties and resorts often book 12 or more months ahead, especially for fall weekends. If you have a specific venue in mind, the sooner we can start, the more dates we can protect for you.",
    },
  ],
  closingBody:
    "Tell us your date, your venue (or the ones you're considering), and how many guests are traveling in. We'll follow up within one business day with next steps.",
};
